package com.rdc.pet.mypet.manager;
...
import com.rdc.pet.mypet.view.MenuView;
import com.rdc.pet.mypet.view.PetView;

import java.lang.reflect.Field;
import java.util.Random;

import static com.rdc.pet.mypet.config.StateConfig.STAND;
import static com.rdc.pet.mypet.config.StateConfig.WALK_TO_LEFT;
import static com.rdc.pet.mypet.config.StateConfig.WALK_TO_RIGHT;
...
public class PetViewManager {
    ...
    public void showPetView() {
        if(petViewLayoutParams == null) {
            ...
            petViewLayoutParams.format = PixelFormat.RGBA_8888;
        }
